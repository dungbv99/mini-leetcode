...
export function ContestManager(){
  ...
  function getUserPending(s, p){
    request(
      "get",
      API_URL+"/get-user-register-pending-contest/"+contestId+"?size="+s+"&page="+(p-1),
      (res) => {
  ...
  function getUserSuccessful(s, p){
    request(
      "get",
      API_URL+"/get-user-register-successful-contest/"+contestId+"?size="+s+"&page="+(p-1),
      (res) => {
        console.log("res pending", res.data);
  ...
  function getRanking(s, p){
    request(
      "get",
      API_URL+"/get-ranking-contest/"+contestId+"?size="+s+"&page="+(p-1),
      (res) =>{
  ...
  function searchUser(keyword, s, p){
    request(
      "get",
      API_URL+"/search-user/"+contestId+"?size="+s+"&page="+(p-1)+"&keyword="+keyword,
      (res) => {
